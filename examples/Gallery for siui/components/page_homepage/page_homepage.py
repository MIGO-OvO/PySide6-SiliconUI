...
class ExampleHomepage(SiPage):
    def __init__(self, *args, **kwargs):
        ...
        self.option_card_project.setDescription(
            "check PySide6-SiliconUI Repository on GitHub to get the latest release, report errors, provide suggestions and more.")  # noqa: E501
        self.option_card_project.setURL("https://github.com/aqquchina/PySide6-SiliconUI-main")
        ...
        self.option_card_example.setDescription("Check examples to understand how to use PySide6-SiliconUI to develop your first work.")  # noqa: E501
