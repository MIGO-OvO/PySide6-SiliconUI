...
class MySiliconApp(SiliconApplication):
    def __init__(self, *args, **kwargs):
        ...
        # 添加按钮到的链接函数
        self.layerMain().app_close_button.attachment().load(SiGlobal.siui.iconpack.get("ic_fluent_dismiss_filled"))
        self.layerMain().app_min_button.attachment().load(SiGlobal.siui.iconpack.get("ic_fluent_line_horizontal_1_filled"))
