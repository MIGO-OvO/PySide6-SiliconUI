...
setup(
    ...
    # 以下为可选元数据
    description = "A powerful and artistic UI library based on PySide6",  # 包的简短描述
    ...
    url = "https://github.com/aqquchina/PySide6-SiliconUI-main",  # 项目主页
    author = "ChinaIceF",  # 作者名
    author_email = "65611232@qq.com",  # 作者邮箱
    license = "GPL-3.0",  # 许可证
    classifiers=[  # 项目的分类信息
