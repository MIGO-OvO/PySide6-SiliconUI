...
class DarkColorGroup(SiColorGroup):
    def __init__(self):
        ...
        #  标题栏颜色
        self.assign(SiColor.INTERFACE_BG_A, "#2B2D30")
        # 主页背景色
        self.assign(SiColor.INTERFACE_BG_B, "#1E1F22")
        # 块背景色
        self.assign(SiColor.INTERFACE_BG_C, "#2B2D30")
        # 表格标题栏颜色
        self.assign(SiColor.INTERFACE_BG_D, "#454547")
